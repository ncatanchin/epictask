...
/***/ function(module, exports, __webpack_require__) {
	...
	chrome.runtime.getBackgroundPage(function (background) {
	  ...
	  var saveOption = function saveOption(e) {
	    var value = void 0;
	    if (e.target.type === 'checkbox') value = e.target.checked;else if (e.target.type === 'input' || e.target.type === 'text') value = Number(e.target.value);else value = e.target.value.trim();
	  ...
	  var saveUrls = function saveUrls(e) {
	  ...
	  syncOptions.get(function (items) {
	    (0, _reactDom.render)(_react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { id: 'maxAge', type: 'text', defaultValue: items.maxAge, onChange: saveOption }),
	        _react2.default.createElement(
	          'span',
	          { className: 'comment' },
	          '(the oldest removed once it\'s reached, >1)'
	        )
	      ),
	      _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement('input', { id: 'filter', type: 'checkbox', defaultChecked: items.filter, onChange: saveOption }),
	        _react2.default.createElement(
	          'span',
	          { className: 'comment' },
	          '(enable to show/hide the actions bellow)'
	        )
	      ),
	      _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement(
	          'span',
	          { className: 'caption' },
	          'Actions to hide from DevTools (from new line):'
	        ),
	        _react2.default.createElement('textarea', { onChange: saveOption, id: 'blacklist', defaultValue: items.blacklist })
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'input' },
	        _react2.default.createElement(
	          'span',
	          { className: 'caption' },
	          'Actions to show (previous option will be ignored):'
	        ),
	        _react2.default.createElement('textarea', { onChange: saveOption, id: 'whitelist', defaultValue: items.whitelist })
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'input' },
	        ...
	        _react2.default.createElement('input', { id: 'serialize', type: 'checkbox', defaultChecked: items.serialize, onChange: saveOption }),
	        _react2.default.createElement(
	          'span',
	          { className: 'comment' },
	          '(required for ImmutableJS states)'
	        )
	      ),
	      _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement('input', { id: 'inject', type: 'checkbox', defaultChecked: items.inject, onChange: saveOption }),
	        _react2.default.createElement(
	          'span',
	          { className: 'comment' },
	          '(disable to allow only the urls bellow)'
	        )
	      ),
	      _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement(
	          'span',
	          { className: 'caption' },
	          'Allowed for the following urls (regex from new line):'
	        ),
	        _react2.default.createElement('textarea', { onChange: saveUrls, id: 'urls', defaultValue: items.urls })
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'input' },
	        ...
	        _react2.default.createElement('input', { id: 'notifyErrors', type: 'checkbox', defaultChecked: items.notifyErrors, onChange: saveOption }),
	        _react2.default.createElement(
	          'span',
	          { className: 'comment' },
	          '(will notify when errors occur in the app)'
	        )
	      )
