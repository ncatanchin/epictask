...
import {JobActionFactory as JobActionFactoryType} from '../actions/jobs/JobActionFactory'
import {RepoActionFactory as RepoActionFactoryType} from 'app/actions/repo/RepoActionFactory'
import {IJob,IScheduledJob,findInProgressJob} from '../actions/jobs/JobState'
...
export async function start() {
	...
	store = require('app/store').getStore()
	const {JobActionFactory} = require('app/actions/jobs/JobActionFactory')
