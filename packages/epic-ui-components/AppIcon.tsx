 ...
 * ILogoProps
 */
export interface IAppIconProps extends IThemedAttributes {
	expanded?:boolean
	eHidden?:boolean
	spinnerStyle?:any
	titleStyle?:any
 ...
 * ILogoState
 */
export interface IAppIconState {
...
@PureRender
export class AppIcon extends React.Component<IAppIconProps,IAppIconState> {
