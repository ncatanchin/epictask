...
import {
	makeBorder, FillWidth, FlexRowCenter, PositionRelative, makeTransition, rem,
	FlexScale, FlexColumnCenter, makePaddingRem, makeFlexAlign, Ellipsis, FlexAuto, FillHeight, Transparent
} from "epic-styles/styles"
export function searchItemBaseStyles(topStyles, theme, palette) {
