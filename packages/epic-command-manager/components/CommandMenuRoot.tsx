...
import {
	getCommandSimpleMenuManager, CommandSimpleMenuManagerEventType,
	CommandSimpleMenuManager
} from "../CommandSimpleMenuManager"
import { ICommandMenuItem, CommandMenuItemType, isCommandFontIcon, isCommandImageIcon } from "../Command"
import { IEnumEventRemover } from "shared/util"
import {
	NavigationArrowDropRight as SvgArrowRight,
	NavigationChevronLeft as SvgArrowLeft,
	NavigationMoreVert as SvgNavMoreIcon,
...
import { KeyboardAccelerator } from "ui/components/common/Renderers"
import { colorAlpha } from "../../themes/styles/ColorTools"
...
export class CommandMenuRoot extends React.Component<ICommandMenuRootProps,ICommandMenuRootState> {
	...
	private makeMenu(menuItems:ICommandMenuItem[]) {
		...
		const
			...
			iconButton = <IconButton iconStyle={{}}>
				<SvgNavMoreIcon />
			</IconButton>
